 ...
 * digits do.
 *
 * It is part of pulseq_file's layout, so every translation unit that touches
 * one has to agree on it. Define PULSEQ_DOUBLE_PRECISION to build a second
 * instance of these sources at double, inside a namespace of its own.
 */
...
#define PULSEQ_ERR_DANGLING_ID -13
